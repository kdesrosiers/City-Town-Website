...
<div class="w3-twothird" style="margin-left:300px">
		...
		<fieldset>
			<legend></legend>
			First Name: <input type="text" required placeholder="Enter your first name" maxlength='25' size="27" name="fname"><p>
			Last Name: <input type="text" required placeholder="Enter your last name" maxlength='25' size="27" name="lname"><p>
			Phone Number: <input type="text" required placeholder="phone number xxx-xxx-xxxx" name="phoneNum" maxlength='15' size="22"><p>
			Cell Number: <input type="text" required placeholder="cell number xxx-xxx-xxxx" name="cellNum" maxlength='15' size="22"><p>
			Email: <input type="text" required placeholder="Enter your email address" maxlength='50' size="53" name="email"><p>
			Address: <input type="text" required placeholder="Enter your address" name="address" maxlength='100' size="50"><p>
