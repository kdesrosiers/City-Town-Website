		 ...
		 <h2>ALARM USER PERMIT APPLICATION</h2>
			...
			<form id="form" method="post" action="Formdba.php" role="form">
				...
				<div>
					...
					<input type="text" class="form-control" id="lname" placeholder="Enter Last name" maxlength='25' size="27" name="lname">
				</div>
					...
					<div class="row">
						<div class="col-md-6">	
							<div class="form-group">
								...
								<input type="text" class="form-control" id="Ename2" placeholder="Enter name" maxlength='50' size="53" name="Ename2">
								</div>
								</div>
						<div class="col-md-6">
							<div class="form-group">
