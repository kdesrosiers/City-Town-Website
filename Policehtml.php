...
<ul>
	...
	<li><a href="accountsettingspolice.php"><i class="fa fa-cog"></i>  ACCOUNT SETTINGS</a></li>
</ul>
</div>
...
<div class="w3-twothird" style="margin-left:250px">
		...
		$sql = "SELECT * FROM feedback WHERE department = 'Police Department'";
...
<div class="container" style="margin-top:35px">
	...
	<table class="w3-table-all w3-hoverable w3-card" id="concerns_table" style="overflow-y:auto">
		...
		<form action="processConcernPolice.php" method="POST">
		...
		<tr>
			...
			<td><?php echo "<a class='active' href='viewpolice.php?var=$ID&var2=5'>View</a>"; ?></td>
		</tr>
		<?php
		$no++;
		}
...
<!--<div class="w3-twothird" style="margin-left:200px">-->
	...
	$sql = "SELECT * FROM forms where curdepartment = 'police'";
	$query = mysqli_query($conn, $sql);
...
<div class="container" style="margin-top:100px">
	...
	<table class="w3-table-all w3-hoverable w3-card" id="forms_table" style="overflow-y:auto; overflow-x:auto">
		...
		<tbody>
			...
			<form action="processFormpolice.php" method="POST">
	  ...
	  echo "<td>";
			echo "<a class='active' href='viewpolice.php?var=$formid'>View</a>";
			echo "</td>";
