...
if(mysqli_connect_error())
{
	...
	$result3 = $conn->query("UPDATE forms SET administrator = 1 WHERE formID = '$var'");
	...
	if($forward == 'forward' && $dept == 'clerk')
	{
		...
		if($forward == 'forward' && $dept == Null)
	{
		$result3 = $conn->query("UPDATE forms SET administrator = 1 WHERE formID = '$var'");


		$result = $conn->query("UPDATE forms SET curdepartment = 'Administrator' WHERE formID = '$var'");
	}
		if($deny != NULL)
	{
