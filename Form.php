	...
	<div class="container" style="margin-left:220px" >
	  <fieldset>
		 <h2>ALARM USER PERMIT APPLICATION</h2>
			...
			<form id="form" required method="post" action="Formdba.php" role="form">
			
				<div class="form-group">
					<label for="fname">First Name:</label>
					<input type="text" class="form-control" id="fname" placeholder="Enter First name" name="fname" maxlength='25' size="27" required="true">
					</div>
				<div>
					<label for="lname">Last Name:</label>
					<input type="text" class="form-control" id="lname" placeholder="Enter Last name" name="lname" maxlength='25' size="27" required="true">
				</div>
				
			 <div class="form-group">
					<label for="address">Address:</label>
					<input type="address" class="form-control" id="address" placeholder="Enter Address" maxlength='100' size="105" name="address" required="true">
				</div>
						
				<div class="form-group">
					<label for="alarmAd">Address of Alarmed Premise:</label>
					<input type="alarmAD" class="form-control" id="alarmAd" placeholder="Enter Address" maxlength='100' size="105" name="alarmAd" required="true">
				</div>
			...
			<div>
				...
				<p>A.	Systems equipped with an audible alerting device which is perceptible outside of the alarmed premises must incorporate a device which will silence such audible signals within twenty (20) minutes of its activation.</b></p>
					...
					<label class="radio" required="true">
						<div>
				...
				<div>
					...
					activation, the central  station monitoring facility must first attempt to verify the authenticity of the alarm and the need for emergency response by police personnel. This MUST include an attempt to contact personsat the alarmed premises. (This requirement doesnot apply to holdup, panicor fire signals).</p></b>
						
						<label class="radio" required="true" required="true">
							<div>
					...
					<p><b>ALARM SERVICE AGENCY - firm which currently services your system</b></p>
						<div class="form-group">
							...
							<input type="text" class="form-control" id="ACname" placeholder="Enter Alarm Company" maxlength='100' size="105" name="ACname" required="true">
						
						</div>
						
					 <div class="form-group">
							<label for="ACaddress">Address:</label>
							<input type="text" class="form-control" id="ACaddress" placeholder="Enter Alarm Company Address" maxlength='100' size="105" name="ACaddress" required="true">
						</div>
								
						<div class="form-group">
							<label for="ACphone">Telephone:</label>
							<input type="text" class="form-control" id="ACphone" placeholder="Enter Telephone number" maxlength='15' size="17" name="ACphone" required="true">
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="Ename1" placeholder="Enter name" maxlength='50' size="53" name="Ename1" required="true">
								</div>
								</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="Ephone1">Telephone: * </label>
								<input type="tel" class="form-control" id="Ephone1" placeholder="Enter telephone" maxlength='15' size="17" name="Ephone1" required="true">
							</div>
							</div>
							</div>
					...
					<div class="row">
						<div class="col-md-6">	
							<div class="form-group">
								...
								<input type="text" class="form-control" id="Ename2" placeholder="Enter name" maxlength='50' size="53" name="Ename2" required="true">
								</div>
								</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="Ephone2">Telephone: * </label>
								<input type="tel" class="form-control" id="Ephone2" placeholder="Enter telephone" maxlength='15' size="17" name="Ephone2" required="true">
							</div>
							</div>
							</div>
					<div class="row">
						<div class="col-md-6">		
							<div class="form-group">
								...
								<input type="text" class="form-control" id="Ename3" placeholder="Enter name" maxlength='50' size="53" name="Ename3">
								</div>
								</div>
						<div class="col-md-6">
							<div class="form-group">
										<label for="Ephone3">Telephone:  </label>
								<input type="tel" class="form-control" id="Ephone3" placeholder="Enter telephone" maxlength='15' size="17" name="Ephone3">
							</div>
							</div>
							</div>
				...
				alarm systems within the Unincorporated Area of the Town of Mamaroneck. I have read same and understand it.
									...
									<div class="form-group">
										...
										<input type="etext" class="form-control" id="appElecSig" placeholder="Electronic Signature " maxlength='50' size="53" name="appElecSig" required="true">
