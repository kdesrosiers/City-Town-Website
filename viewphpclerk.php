...
if(mysqli_connect_error())
{
	...
	$result = $conn->query("UPDATE forms SET fire = 1, clerk = 1, police = 1 WHERE formID = '$var'");
	}
	if($deny != NULL)
	{
	...
	$result3 = $conn->query("UPDATE forms SET clerk = 1 WHERE formID = '$var'");
